...
import { Book, Mail, Lock, Loader2, AlertCircle, Sparkles } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-[var(--bg)] flex items-center justify-center p-4 transition-colors duration-200">
      <div className="w-full max-w-md bg-[var(--surface)] border border-[var(--border)] rounded-sm p-8 shadow-sm flex flex-col gap-6 select-none relative overflow-hidden">
        ...
        {/* Success Alert */}
        {success ? (
          <div className="flex flex-col items-center gap-3 p-6 bg-emerald-50 dark:bg-emerald-950/20 border border-emerald-200 dark:border-emerald-900/50 rounded-sm text-center text-sm text-emerald-800 dark:text-emerald-400">
            ...
            <div className="flex flex-col gap-1">
              ...
              <span className="text-xs text-emerald-700 dark:text-emerald-500">
                Preparing your workspaces. Redirecting shortly...
              </span>
            </div>
          </div>
        ) : (
          <>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-mono uppercase tracking-wider text-[var(--text-muted)]" htmlFor="confirm-password">
                  Confirm Password
                </label>
                <div className="relative">
                  <span className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[var(--text-muted)]">
