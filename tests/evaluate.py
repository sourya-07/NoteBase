...
from src.core.database import load_subjects
...
DEFAULT_QUESTIONS = [
    ...
    "What are best practices for building a production RAG system?",
]
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="ChromaDB collection name to evaluate against (defaults to first subject)",
    )
    parser.add_argument(
        "--questions",
        type=str,
